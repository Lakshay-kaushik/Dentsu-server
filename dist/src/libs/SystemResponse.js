...
const CodeMessages_1 = require("./CodeMessages");
...
class SystemResponse {
    ...
    static requestEntityTooLargeError(message, error) {
        return SystemResponse.getInstance().getErrorResponse(message, error, StatusCodes_1.default.REQUEST_ENTITY_TOO_LARGE);
    }
    /**
     * This method gets message and error as parameter and returns the formatted object.
     * @param {String} message Custom error message.
